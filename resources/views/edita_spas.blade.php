...
<div class="col-md-4">
	...
	{!! Form::model('spa', ['route' => ['spas.update', $spa->id], 'method' => 'PATCH']) !!}
		...
		<div class="form-group">
			...
			{!! Form::text('web', $spa->web, ['class'=> 'form-control', 'id' => 'web']) !!}

		</div>
		<div class="form-group">
			<label for="promocion">Promoción *dejar vacio si no aplica</label>
			{!! Form::text('promocion', $spa->promocion, ['class'=> 'form-control', 'id' => 'promocion']) !!}
